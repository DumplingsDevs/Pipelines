...
{
    public (ExampleCommandResult, ExampleCommandResult2, ExampleCommandResult3, ExampleCommandResult4,
            ...
            CancellationToken token)
    {
        return (new ExampleCommandResult(input.Value),
            ...
            new ExampleCommandResult5(new Rectangle(10, 10, 10, 10)),
            new ExampleCommandResult6(DateTime.Parse("2023-05-06 22:30:00.531")),
