...
public class
    FourthRequestDecoratorUniqueNameForSearch : IRequestHandler<ExampleRequest,
        ExampleCommandResult>
{
    private readonly IRequestHandler<ExampleRequest, ExampleCommandResult> _handler;
    private readonly DecoratorsState _state;

    public FourthRequestDecoratorUniqueNameForSearch(
    ...
    {
        _state.Status.Add(nameof(FourthRequestDecoratorUniqueNameForSearch));
