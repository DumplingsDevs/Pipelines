...
internal class IsGenericMismatchException : Exception
{
    ...
    public IsGenericMismatchException(Type type1, bool isType1Generic, Type sourceType1, Type isGenericType2,
